namespace Tools {
    export class JsonConigUtils {
         ...
         */
        public static ReadJsonObjectByPath(path: string, callBack: (error: Error, object: object) => void) {
         ...
         */
        public static ReadJsonObjectByName(name: string, callBack: (error: Error, object: object) => void) {
